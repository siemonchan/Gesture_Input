...
def detection(frame):
    ...
    # Largest area contour, as the area of hand detected
    cnts = contours[ci]
    ...
    '''
    # all code below is to locate all five fingers (if exist)
    # Find convex defects
    ...
    if cnts.any():
        ...
        return frame, x, y, w, h, cnts_x, cnts_y
    else:
        return frame, 0, 0, 0, 0, None, None
